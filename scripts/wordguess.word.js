...
async function word_for_today() {
    ...
    var list = ["word", "moon", "create", "updated", "fortunate", "secondly", "cringe", "undid", "arch", "universe", "plum", "inspect", "upset", "transcontinental", "uncontrollable", "asynchronous", "facilitate", "uproar"];
